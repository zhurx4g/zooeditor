...
public class JZVStat extends JPanel {
    ...
    public JZVStat() {
        ...
        statsPane.add(this.ctime);
        statsPane.add(this.mtime);
        statsPane.add(this.version);
        statsPane.add(this.aversion);
        statsPane.add(this.cversion);
        statsPane.add(this.czxid);
        statsPane.add(this.mzxid);
        statsPane.add(this.pzxid);
        statsPane.add(this.dataLength);
        statsPane.add(this.ephemeralOwner);
        statsPane.add(this.numChildren);
        this.add(statsPane);
    }
